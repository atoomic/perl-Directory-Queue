...
# ABSTRACT: Object oriented interface to a simple directory based queue
...
sub remove : method {
    ...
    # unlink lock file first: if interrupted after this point,
    # the data file remains accessible (not orphaned behind a stale lock)
